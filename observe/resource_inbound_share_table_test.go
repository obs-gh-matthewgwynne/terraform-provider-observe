	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Step 3: Import - verify composite ID import works
			{
				...
				// The convertTableStateToResourceWithDatasetLabel function needs to be updated
				// to include these fields in the ExternalShares-TableResource response.
				// Location: /home/matthew.gwynne/observe/code/go/src/observe/restapiservices/shareinapi/sharein_conversions.go:115
				// OpenAPI: /home/matthew.gwynne/observe/code/openapi/sharein/sharein.yaml ExternalShares-TableResource
				// Additionally, DatasetRef needs to include 'kind' field (currently only has id/label).
				// OpenAPI: /home/matthew.gwynne/observe/code/openapi/common/schemas.yaml DatasetRef
